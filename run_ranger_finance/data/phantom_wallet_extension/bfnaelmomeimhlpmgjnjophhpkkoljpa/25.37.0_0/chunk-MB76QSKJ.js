import{e as ce}from"./chunk-O5ORMZOU.js";import{a as E,c as z,d as K,e as H,f as _}from"./chunk-WSHVJYZQ.js";import{a as h}from"./chunk-S2U2M74Z.js";import{a as pe,b as V}from"./chunk-NHAVVXOV.js";import{sc as de,tc as le}from"./chunk-G7SUPDIB.js";import{a as M}from"./chunk-MGZWMRRY.js";import{db as x,m as a,u as W}from"./chunk-NF4WCJZY.js";import{c as ae}from"./chunk-VQ7QS3TU.js";import{g as se}from"./chunk-XO3ZXIMS.js";import{Fa as N,Hb as U,Ia as te,La as oe,T as R,Ta as re,Wb as ie,Y as ee,kb as ne,p as Y,y as Z}from"./chunk-LN2IIXED.js";import{Ga as G,Pc as Q,Zb as A,jd as J}from"./chunk-ZKZ45RUP.js";import{Ga as v,I as X,J as q,X as g,c as C,fb as b,ya as L}from"./chunk-HUAJDUGD.js";import{f as I,h as p,n as c}from"./chunk-SXSSBWAU.js";p();c();var n=I(C());p();c();var r=I(C());var ue=({onChange:e,value:t,networkID:o})=>{let d=N(),i=(0,r.useMemo)(()=>{if(!o)return[];let f=A.getAddressTypes(o);return d.filter(l=>f.includes(l))},[d,o]);if(!i||i.length===0)return null;let m=i.includes(t)?t:i[0];return r.default.createElement(Ce,{onChange:e,value:m},({isExpanded:f})=>r.default.createElement(r.default.Fragment,null,r.default.createElement(ve,{isActive:f},r.default.createElement(me,{networkID:o,addressType:m},r.default.createElement(fe,null,r.default.createElement(W,{fill:L.colors.legacy.textDiminished,width:10})))),r.default.createElement(be,{portal:!1},r.default.createElement(H,{maxHeight:"300px"},i?.filter(l=>l!==m)?.map(l=>r.default.createElement(Te,{key:l,value:l},r.default.createElement(me,{networkID:o,addressType:l})))))))},me=({addressType:e,networkID:t,children:o})=>!t||!e?null:r.default.createElement(h,{justify:"space-between"},r.default.createElement(h,null,r.default.createElement(M,{networkID:t,size:32}),r.default.createElement(ke,null,G.getDisplayName(e))),o),Ce=a(E)`
  width: 100%;
  position: relative;
`,fe=a.div`
  display: inline-flex;
...
//# sourceMappingURL=chunk-MB76QSKJ.js.map
