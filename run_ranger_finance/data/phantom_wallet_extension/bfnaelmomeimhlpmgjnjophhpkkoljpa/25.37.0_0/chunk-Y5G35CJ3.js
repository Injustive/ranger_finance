import{m as l}from"./chunk-NF4WCJZY.js";import{ya as c}from"./chunk-HUAJDUGD.js";import{h as r,n as o}from"./chunk-SXSSBWAU.js";r();o();var m=(e,t)=>{let i=parseInt(e.slice(1,3),16),a=parseInt(e.slice(3,5),16),n=parseInt(e.slice(5,7),16);return typeof t=="number"?"rgba("+i+", "+a+", "+n+", "+t+")":"rgb("+i+", "+a+", "+n+")"};r();o();var f=l.div.attrs(e=>({color:e.color??c.colors.legacy.elementAccent,diameter:e.diameter??24,opacity:e.opacity??1}))`
...
//# sourceMappingURL=chunk-Y5G35CJ3.js.map
